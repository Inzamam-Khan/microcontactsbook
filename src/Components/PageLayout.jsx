...
return(
    <div className=" border-red-500 flex flex-col w-full">
        
        <Header menu={<Menu/>} isOpen={isOpen} setIsOpen={setIsOpen}/>
...
const Timeline=()=>{
    return(
    <div className="flex flex-col p-4 max-md:hidden">

<span className="text-xl font-semibold -mt-4 mb-4 " >News</span> 
...
<ol className="relative border-s border-gray-200 dark:border-gray-700   ">                  
    ...
    <li className="mb-10 ms-6  ">            
        <span className=" absolute  flex items-center justify-center w-6 h-6 -ml-1 bg-blue-100 rounded-full -start-3 ring-8 ring-white dark:ring-gray-900 dark:bg-blue-900">
            <svg className=" border-blue-500 w-2.5 h-2.5 text-blue-800 dark:text-blue-300" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
                <path d="M20 4a2 2 0 0 0-2-2h-2V1a1 1 0 0 0-2 0v1h-3V1a1 1 0 0 0-2 0v1H6V1a1 1 0 0 0-2 0v1H2a2 2 0 0 0-2 2v2h20V4ZM0 18a2 2 0 0 0 2 2h16a2 2 0 0 0 2-2V8H0v10Zm5-8h10a1 1 0 0 1 0 2H5a1 1 0 0 1 0-2Z"/>
            </svg>
        </span>
        <h3 className="flex items-center mb-1 text-lg font-semibold text-blue-500 dark:text-white">Flowbite Application UI v2.0.0 <span className="bg-blue-100 text-blue-800 text-sm font-medium me-2 px-2.5 py-0.5 rounded dark:bg-blue-900 dark:text-blue-300 ms-3">Latest</span></h3>
    ...
    <li className="mb-10 ms-6 ">
        ...
        <h3 className="mb-1 text-lg  text-blue-500 font-semibold  dark:text-white">Flowbite Figma v1.3.0</h3>
    ...
    <li className="ms-6">
        ...
        <h3 className="mb-1 text-lg font-semibold text-blue-500 dark:text-white">Flowbite Library v1.2.2</h3>

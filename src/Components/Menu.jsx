...
export default function Menu({ setShow,isOpen,setIsOpen }) {
    ...
    return (
        ...
        <div className="menu_main md:border-r border-slate-gray  bg-transparent flex flex-wrap items-start justify-start  p-5 h-[85vh]" style={{ zIndex: '99999' }}>
            ...
            <div className="cursor-pointer search flex items-center justify-start gap-3 border
             border-slate-gray rounded-xl p-1 w-full px-4 " onClick={() => { setShowSearch(true);}}>
                ...
                <input type="text" className=" px-2 search_field   w-full outline-none border-none " value={searchValue} onChange={(e) => { setSearchValue(e.target.value) }} placeholder='Search' />
            </div>
            ...
            <div className=" flex items-center justify-start mt-auto  gap-3  rounded-xl p-1 w-full px-4 " >
